        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goals_ReviewPeriods_ReviewPeriodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewEvents_ReviewPeriods_ReviewPeriodId",
                        column: x => x.ReviewPeriodId,
                        principalTable: "ReviewPeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewEvents_Users_RevieweeId",
                        column: x => x.RevieweeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewEvents_Users_ReviewerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Actionables_Goals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Actionables_GoalId",
                table: "Actionables",
                column: "GoalId");

            migrationBuilder.CreateIndex(
                name: "IX_Goals_ReviewPeriodId",
                table: "Goals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewEvents_RevieweeId",
                table: "ReviewEvents",
                column: "RevieweeId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewEvents_ReviewerId",
                table: "ReviewEvents",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewEvents_ReviewPeriodId",
                table: "ReviewEvents",
                column: "ReviewPeriodId");
